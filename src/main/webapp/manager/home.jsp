...
<div class="container mt-4">
    <div class="row">
        <div class="col-12">
            <h2 class="header text-center">Giao diện quản lý danh mục (Manager)</h2>
                ...
                <div class="row">
                    ...
                    <div class="col-md-3 text-end">
                        <div class="btn-group w-100">
                            ...
                            <a href="${pageContext.request.contextPath}/manager/view-profile" class="btn btn-info">Xem Profile</a>
                        </div>
                    </div>
                </div>
            </div>
                    ...
                    <tbody>
                        <c:forEach var="category" items="${categories}">
                            <tr>
                                ...
                                <td>
                                    <img src="${pageContext.request.contextPath}/Uploads/${category.icons}" alt="Icon" class="category-icon" onerror="this.src='${pageContext.request.contextPath}/Uploads/default-icon.png'">
                                </td>
                                <td>
